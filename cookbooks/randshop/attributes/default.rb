...
# for basic auth right after install (before configuration)
default['randshop']['overwrite_htaccess'] = false
default['randshop']['htpasswd'] = "#{node['randshop']['docroot']}/admin/data/.passwd"
